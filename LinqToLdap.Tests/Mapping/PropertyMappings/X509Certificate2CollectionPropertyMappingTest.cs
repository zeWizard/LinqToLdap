...
namespace LinqToLdap.Tests.Mapping.PropertyMappings
{
    ...
    public class X509Certificate2CollectionPropertyMappingTest
    {
        ...
        public void IsEqual_SameLengthDifferentCollections_ReturnsFalse()
        {
            //prepare
            _mappingArguments.PropertyType = typeof(Collection<X509Certificate2>);
            _mappingArguments.Getter = t => new Collection<X509Certificate2>(new[] { new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer")), new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer")) });
            var propertyMapping = new X509Certificate2CollectionPropertyMapping<X509Certificate2CollectionPropertyMappingTest>(_mappingArguments);
            DirectoryAttributeModification modification;
            //act
            var value = propertyMapping.IsEqual(this, new Collection<X509Certificate2>(new[] { new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer")), new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer2")) }), out modification);
        ...
        public void IsEqual_SameArrays_ReturnsTrue()
        {
            //prepare
            _mappingArguments.PropertyType = typeof(Collection<X509Certificate>);
            _mappingArguments.Getter = t => new Collection<X509Certificate>(new[] { new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer")), new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer2")) });
            var propertyMapping = new X509Certificate2CollectionPropertyMapping<X509Certificate2CollectionPropertyMappingTest>(_mappingArguments);
            DirectoryAttributeModification modification;
            //act
            var value = propertyMapping.IsEqual(this, new Collection<X509Certificate>(new[] { new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer")), new X509Certificate2(Resources.ResourceHelper.GetAssemblyResource(@"Resources\cert.cer2")) }), out modification);
